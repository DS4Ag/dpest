    ...
    **Examples:**
    ...
    1. **Basic Usage (Required Arguments Only):**
       ...
       .. code-block:: python
           ...
           # The returned tuple and path are saved in variables that can be used later
